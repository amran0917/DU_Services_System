...
<body>
    ...
    <div>
        This is to certify that {{ $stdnt->name}} S/o, {{$stdnt->father_name}} &amp; {{$stdnt->mother_name}},33/4,
        Monikutir, Nayapara, Charpara, Mymensingh-2200, was a student of the Master in
        ...
        CGPA is 3.46 on a scale of 4.00.
        <br>
        <br>
        <br>
